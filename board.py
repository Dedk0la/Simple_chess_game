...
class Board:
    ...
    def cacl_moves(self, piece, row, col, bool=True):
            ...
            for passible_move in passible_moves:
                ...
                if Square.in_range(passible_move_row, passible_move_col):
                    if self.squares[passible_move_row][passible_move_col].is_empty_or_enemy(piece.color):
                        ...
                        final_piece = self.squares[passible_move_row][passible_move_col].piece
                        final = Square(passible_move_row, passible_move_col, final_piece)
        ...
        for row in range(ROWS):
            for col in range(COLS):
                if temp_board.squares[row][col].has_enemy_piece(piece.color):
                    ...
                    temp_board.cacl_moves(p, row, col, bool=False)
                    for m in p.moves:
